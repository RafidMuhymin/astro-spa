...
var require_base64 = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/base64.js"(exports) {
    var intToCharMap =
...
var require_base64_vlq = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/base64-vlq.js"(exports) {
...
var require_util = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/util.js"(exports) {
...
var require_array_set = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/array-set.js"(exports) {
    var ArraySet = class {
      constructor() {
        this._array = [];
        this._set = new Map();
...
var require_mapping_list = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/mapping-list.js"(exports) {
...
var require_binary_search = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/binary-search.js"(exports) {
...
var require_wasm = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/wasm.js"(exports, module) {
      ...
      originalPositionFor(aArgs) {
        ...
        const sectionIndex = binarySearch.search(
          ...
          function (aNeedle, section2) {
            const cmp =
              aNeedle.generatedLine - section2.generatedOffset.generatedLine;
            if (cmp) {
              return cmp;
            }
            return (
              aNeedle.generatedColumn - section2.generatedOffset.generatedColumn
            );
          }
        );
...
var require_source_node = __commonJS({
  "node_modules/terser/node_modules/source-map/lib/source-node.js"(exports) {
...
var require_source_map = __commonJS({
  "node_modules/terser/node_modules/source-map/source-map.js"(exports) {
...
var MAP = (function () {
  ...
  MAP2.at_top = function (val) {
    return new AtTop(val);
  };
  MAP2.splice = function (val) {
    return new Splice(val);
  };
  MAP2.last = function (val) {
    return new Last(val);
  };
  var skip = (MAP2.skip = {});
  function AtTop(val) {
...
function from_char_code(code) {
  if (code > 65535) {
    code -= 65536;
    return (
      String.fromCharCode((code >> 10) + 55296) +
      String.fromCharCode((code % 1024) + 56320)
    );
  }
    ...
    switch (ch.charCodeAt(0)) {
      ...
      case 117:
        if (peek() == "{") {
          ...
          if (
            length > 6 ||
            (result = hex_bytes(length, strict_hex)) > 1114111
          ) {
...
function parse($TEXT, options) {
  ...
  var statement = embed_tokens(function statement2(
    is_export_default,
    is_for_body,
    is_if_body
  ) {
  ...
  function track_used_binding_identifiers(is_parameter, strict) {
    ...
    var tracker = {
      add_parameter: function (token) {
        if (parameters2.has(token.value)) {
          if (duplicate === false) {
            duplicate = token;
          }
          tracker.check_strict();
        } else {
          parameters2.add(token.value);
          if (is_parameter) {
            switch (token.value) {
              case "arguments":
              case "eval":
      ...
      check_strict: function () {
        if (tracker.is_strict() && duplicate !== false) {
          token_error(
            duplicate,
            "Parameter " + duplicate.value + " was used already"
          );
        }
      },
    };
  ...
  function parameter(used_parameters, symbol_type) {
    ...
    if (used_parameters === void 0) {
      used_parameters = track_used_binding_identifiers(
        true,
        S.input.has_directive("use strict")
      );
    }
  ...
  var object_or_destructuring_ = embed_tokens(
    function object_or_destructuring_2() {
      var start = S.token,
        first = true,
        a = [];
      expect("{");
  ...
  function concise_method_or_getset(name, start, is_class) {
    ...
    if (accessor_type != null) {
      if (!is_private) {
        ...
        return new AccessorClass({
          ...
          key: name,
          quote:
            name instanceof AST_SymbolMethod ? property_token.quote : void 0,
    ...
    if (is_class) {
      ...
      const quote =
        key instanceof AST_SymbolClassProperty ? property_token.quote : void 0;
  ...
  function map_names(is_import) {
    ...
    if (is("punc", "{")) {
      ...
      if (is_import && is("name", "as")) {
        next();
        name = as_symbol(
          is_import ? AST_SymbolImport : AST_SymbolExportForeign
        );
      }
  ...
  "label",
  {
    ...
    clone: function (deep) {
      ...
      if (deep) {
        ...
        var def = this.label;
        node.walk(
          new TreeWalker(function (node2) {
            if (
              node2 instanceof AST_LoopControl &&
              node2.label &&
              node2.label.thedef === def
            ) {
...
def_transform(AST_Block, function (self2, tw) {
  self2.body = do_list(self2.body, tw);
});
...
def_transform(AST_Definitions, function (self2, tw) {
  self2.definitions = do_list(self2.definitions, tw);
});
...
def_transform(AST_Call, function (self2, tw) {
  self2.expression = self2.expression.transform(tw);
  self2.args = do_list(self2.args, tw);
});
def_transform(AST_Sequence, function (self2, tw) {
  const result = do_list(self2.expressions, tw);
...
def_transform(AST_Array, function (self2, tw) {
  self2.elements = do_list(self2.elements, tw);
});
def_transform(AST_Object, function (self2, tw) {
  self2.properties = do_list(self2.properties, tw);
});
...
def_transform(AST_Import, function (self2, tw) {
  ...
  if (self2.imported_names) do_list(self2.imported_names, tw);
...
(function () {
  ...
  var MOZ_TO_ME = {
    ...
    MethodDefinition: function (M) {
      var args = {
        ...
        key: M.computed
          ? from_moz(M.key)
          : new AST_SymbolMethod({ name: M.key.name || M.key.value }),
        value: from_moz(M.value),
        static: M.static,
      };
      if (M.kind == "get") {
    ...
    VariableDeclaration: function (M) {
      return new (
        M.kind === "const" ? AST_Const : M.kind === "let" ? AST_Let : AST_Var
      )({
        start: my_start_token(M),
        end: my_end_token(M),
    ...
    ExportNamedDeclaration: function (M) {
      return new AST_Export({
        ...
        exported_names:
          M.specifiers && M.specifiers.length
            ? M.specifiers.map(function (specifier) {
                return new AST_NameMapping({
  ...
  MOZ_TO_ME.ClassDeclaration = MOZ_TO_ME.ClassExpression =
    function From_Moz_Class(M) {
      return new (
        M.type === "ClassDeclaration" ? AST_DefClass : AST_ClassExpression
      )({
        start: my_start_token(M),
        end: my_end_token(M),
        name: from_moz(M.id),
  ...
  map(
    "ForOfStatement",
    AST_ForOf,
    "left>init, right>object, body>body, await=await"
  );
  ...
  map(
    "CallExpression",
    AST_Call,
    "callee>expression, optional=optional, arguments@args"
  );
  ...
  def_to_moz(
    ...
    function To_Moz_TaggedTemplateExpression(M) {
      return {
  ...
  def_to_moz(AST_Function, function To_Moz_FunctionExpression(M, parent) {
    var is_generator =
      parent.is_generator !== void 0 ? parent.is_generator : M.is_generator;
    return {
  ...
  def_to_moz(AST_Definitions, function To_Moz_VariableDeclaration(M) {
    return {
      ...
      kind:
        M instanceof AST_Const ? "const" : M instanceof AST_Let ? "let" : "var",
  ...
  def_to_moz(AST_Binary, function To_Moz_BinaryExpression(M) {
    ...
    const type =
      M.operator == "&&" || M.operator == "||" || M.operator === "??"
        ? "LogicalExpression"
        : "BinaryExpression";
    return {
      type,
  ...
  def_to_moz(AST_ObjectProperty, function To_Moz_Property(M, parent) {
    ...
    var computed = string_or_num
      ? false
      : !(M.key instanceof AST_Symbol) || M.key instanceof AST_SymbolRef;
  ...
  def_to_moz(AST_ConciseMethod, function To_Moz_MethodDefinition(M, parent) {
    ...
    const key =
      M instanceof AST_PrivateMethod
        ? {
            type: "PrivateIdentifier",
            name: M.key.name,
          }
  ...
  def_to_moz(AST_Class, function To_Moz_Class(M) {
    var type =
      M instanceof AST_ClassExpression ? "ClassExpression" : "ClassDeclaration";
    return {
      type,
  ...
  function map(moztype, mytype, propmap) {
    ...
    moz_to_me = new Function(
      ...
      "from_moz",
      "return(" + moz_to_me + ")"
    )(ast_exports, my_start_token, my_end_token, from_moz);
...
function first_in_statement(stack) {
  ...
  for (let i = 0, p; (p = stack.parent(i)); i++) {
    ...
    if (
      (p instanceof AST_Sequence && p.expressions[0] === node) ||
...
var Rope = class {
  ...
  insertAt(char, index) {
    ...
    if (index < committed.length) {
      this.committed =
        committed.slice(0, index) + char + committed.slice(index);
...
function OutputStream(options) {
  ...
  if (options.shorthand === void 0) options.shorthand = options.ecma > 5;
  ...
  function prepend_comments(node) {
    ...
    if (return_with_value) {
      var tw = new TreeWalker(function (node2) {
        ...
        if (
          ...
          (parent instanceof AST_Binary && parent.left === node2) ||
          (parent.TYPE == "Call" && parent.expression === node2) ||
          (parent instanceof AST_Conditional && parent.condition === node2) ||
          (parent instanceof AST_Dot && parent.expression === node2) ||
          (parent instanceof AST_Sequence && parent.expressions[0] === node2) ||
          (parent instanceof AST_Sub && parent.expression === node2) ||
    ...
    if (current_pos == 0) {
      if (
        ...
        !printed_comments2.has(comments[0])
      ) {
    ...
    comments = comments
      ...
      .filter((c) => !printed_comments2.has(c));
...
(function () {
  ...
  AST_Node.DEFMETHOD("print", function (output, force_parens) {
    var self2 = this,
      generator = self2._codegen;
    if (self2 instanceof AST_Scope) {
      output.active_scope = self2;
    } else if (
      !output.use_asm &&
      self2 instanceof AST_Directive &&
      self2.value == "use asm"
    ) {
  ...
  AST_Arrow.DEFMETHOD("_do_print", function (output) {
    ...
    var needs_parens =
      ...
      (parent instanceof AST_Call && self2 === parent.expression);
    if (needs_parens) {
      output.print("(");
    }
    if (self2.async) {
    ...
    if (
      self2.argnames.length === 1 &&
      self2.argnames[0] instanceof AST_Symbol
    ) {
  ...
  function make_then(self2, output) {
    ...
    force_statement(self2.body, output);
  }
  DEFPRINT(AST_If, function (self2, output) {
    ...
    if (self2.alternative) {
      ...
      output.print("else");
      output.space();
      if (self2.alternative instanceof AST_If) self2.alternative.print(output);
      else force_statement(self2.alternative, output);
    } else {
      self2._do_print_body(output);
    }
  });
  ...
  DEFPRINT(AST_Import, function (self2, output) {
    ...
    if (self2.imported_names) {
      if (
        self2.imported_names.length === 1 &&
        self2.imported_names[0].foreign_name.name === "*"
      ) {
  ...
  DEFPRINT(AST_NameMapping, function (self2, output) {
    ...
    var names_are_different =
      ((definition && definition.mangled_name) || self2.name.name) !==
      self2.foreign_name.name;
    if (names_are_different) {
      if (is_import) {
        output.print(self2.foreign_name.name);
      } else {
        self2.name.print(output);
      }
      output.space();
  ...
  DEFPRINT(AST_Export, function (self2, output) {
    ...
    if (self2.exported_names) {
      if (
        self2.exported_names.length === 1 &&
        self2.exported_names[0].name.name === "*"
      ) {
    ...
    if (
      (self2.exported_value &&
        !(
          self2.exported_value instanceof AST_Defun ||
          self2.exported_value instanceof AST_Function ||
          self2.exported_value instanceof AST_Class
        )) ||
      self2.module_name ||
  ...
  DEFPRINT(AST_Call, function (self2, output) {
    self2.expression.print(output);
    if (self2 instanceof AST_New && self2.args.length === 0) return;
    if (
      self2.expression instanceof AST_Call ||
      self2.expression instanceof AST_Lambda
    ) {
  ...
  DEFPRINT(AST_UnaryPrefix, function (self2, output) {
    ...
    if (
      /^[a-z]/i.test(op) ||
      (/[+-]$/.test(op) &&
        self2.expression instanceof AST_UnaryPrefix &&
        /^[+-]/.test(self2.expression.operator))
    ) {
      output.space();
    }
    self2.expression.print(output);
  ...
  DEFPRINT(AST_Binary, function (self2, output) {
    ...
    if (
      op[0] == ">" &&
      self2.left instanceof AST_UnaryPostfix &&
      self2.left.operator == "--"
    ) {
      output.print(" ");
    } else {
    ...
    if (
      (op == "<" || op == "<<") &&
      self2.right instanceof AST_UnaryPrefix &&
      self2.right.operator == "!" &&
      self2.right.expression instanceof AST_UnaryPrefix &&
      self2.right.expression.operator == "--"
    ) {
      output.print(" ");
    } else {
      output.space();
  ...
  DEFPRINT(AST_Class, function (self2, output) {
    ...
    if (self2.extends) {
      var parens =
        !(self2.extends instanceof AST_SymbolRef) &&
        !(self2.extends instanceof AST_PropAccess) &&
        !(self2.extends instanceof AST_ClassExpression) &&
        !(self2.extends instanceof AST_Function);
  ...
  DEFPRINT(AST_ObjectKeyVal, function (self2, output) {
    ...
    if (
      allowShortHand &&
      self2.value instanceof AST_Symbol &&
      is_identifier_string(
        self2.key,
        output.option("ecma") >= 2015 || output.option("safari10")
      ) &&
      get_name(self2.value) === self2.key &&
      !ALL_RESERVED_WORDS.has(self2.key)
    ) {
      print_property_name(self2.key, self2.quote, output);
    } else if (
      allowShortHand &&
      self2.value instanceof AST_DefaultAssign &&
      self2.value.left instanceof AST_Symbol &&
      is_identifier_string(
        self2.key,
        output.option("ecma") >= 2015 || output.option("safari10")
      ) &&
  ...
  DEFMAP(
    [AST_ObjectGetter, AST_ObjectSetter, AST_PrivateGetter, AST_PrivateSetter],
    function (output) {
...
var mkshallow = (props) => {
  const comparisons = Object.keys(props)
    .map((key) => {
      if (props[key] === "eq") {
...
AST_Scope.DEFMETHOD(
  "figure_out_scope",
  function (options, { parent_scope = null, toplevel = this } = {}) {
    ...
    var tw = new TreeWalker((node, descend) => {
      if (node.is_block_scope()) {
        ...
        const parent_scope2 =
          node instanceof AST_Catch ? save_scope2.parent_scope : save_scope2;
        scope.init_scope_vars(parent_scope2);
      ...
      if (node instanceof AST_SymbolLambda) {
        ...
        if (node instanceof AST_SymbolBlockDeclaration) {
          ...
          def = defun.def_variable(
            node,
            node.TYPE == "SymbolVar" ? null : void 0
          );
        }
        if (
          !def.orig.every((sym2) => {
            ...
            return !(
              sym2 instanceof AST_SymbolLet || sym2 instanceof AST_SymbolConst
            );
          })
        ) {
          js_error(
    ...
    function mark_export(def, level) {
      ...
      if (
        (def.export = node instanceof AST_Export ? MASK_EXPORT_DONT_MANGLE : 0)
      ) {
    ...
    if (options.ie8 || options.safari10) {
      walk(this, (node) => {
        if (node instanceof AST_SymbolCatch) {
          ...
          var def =
            scope2.find_variable(name) ||
            toplevel.globals.get(name) ||
            scope2.def_variable(node);
...
AST_Scope.DEFMETHOD("conflicting_def_shallow", function (name) {
  return (
    this.enclosed.find((def) => def.name === name) || this.variables.has(name)
  );
});
...
var def_size = (size, def) => size + list_overhead(def.definitions);
...
var object_methods = ["constructor", "toString", "valueOf"];
...
(function (def_is_number) {
  ...
  def_is_number(AST_Assign, function (compressor) {
    return (
      numeric_ops.has(this.operator.slice(0, -1)) ||
...
(function (def_has_side_effects) {
  ...
  def_has_side_effects(AST_Switch, function (compressor) {
    return (
      this.expression.has_side_effects(compressor) || any(this.body, compressor)
    );
  });
  ...
  def_has_side_effects(AST_SymbolRef, function (compressor) {
    return (
      !this.is_declared(compressor) && !pure_prop_access_globals.has(this.name)
    );
  });
...
(function (def_aborts) {
  ...
  def_aborts(AST_Import, function () {
    return null;
  });
...
def_drop_side_effect_free(
  AST_Binary,
  function (compressor, first_in_statement2) {
...
def_drop_side_effect_free(
  ...
  function (compressor, first_in_statement2) {
    const computed_key =
      this instanceof AST_ObjectKeyVal && this.key instanceof AST_Node;
    const key =
      computed_key &&
      this.key.drop_side_effect_free(compressor, first_in_statement2);
    const value =
      this.value &&
      this.value.drop_side_effect_free(compressor, first_in_statement2);
    if (key && value) {
...
function reset_def(compressor, def) {
  ...
  if (def.scope.pinned()) {
    ...
    def.orig[0] instanceof AST_SymbolConst ||
...
function mark_lambda(tw, descend, compressor) {
  ...
  if (
    ...
    this.argnames.forEach((arg, i) => {
      ...
      if (
        d.fixed === void 0 &&
        (!this.uses_arguments || tw.has_directive("use strict"))
      ) {
        d.fixed = function () {
...
function tighten_body(statements, compressor) {
  ...
  function collapse(statements2, compressor2) {
    if (scope.pinned()) return statements2;
    var args;
    var candidates = [];
    ...
    var scanner = new TreeTransformer(
      function (node) {
        ...
        if (
          !stop_if_hit &&
          (!lhs_local || !replace_all) &&
          ((parent instanceof AST_Binary &&
            lazy_op.has(parent.operator) &&
            parent.left !== node) ||
        ...
        if (
          ...
          if (candidate instanceof AST_VarDef) {
            ...
            if (
              def2.references.length - def2.replaced == 1 &&
              !compressor2.exposed(def2)
            ) {
              def2.replaced++;
        ...
        if (
          ...
          (node instanceof AST_PropAccess &&
            (side_effects ||
              node.expression.may_throw_on_access(compressor2))) ||
          (node instanceof AST_SymbolRef &&
          ...
          (may_throw &&
            (in_try
              ? node.has_side_effects(compressor2)
              : side_effects_external(node)))
        ) {
          stop_after = node;
    ...
    while (--stat_index >= 0) {
      if (stat_index == 0 && compressor2.option("unused")) extract_args();
      var hit_stack = [];
      ...
      while (candidates.length > 0) {
        ...
        if (!can_replace) {
          for (
            var j = compressor2.self().argnames.lastIndexOf(candidate.name) + 1;
            !abort && j < args.length;
            j++
          ) {
    ...
    function redefined_within_scope(def2, scope2) {
      if (def2.global) return false;
      let cur_scope = def2.scope;
      while (cur_scope && cur_scope !== scope2) {
    ...
    function has_overlapping_symbol(fn, arg, fn_strict) {
      var found = false,
        scan_this = !(fn instanceof AST_Arrow);
      arg.walk(
        new TreeWalker(function (node, descend) {
          ...
          if (
            ...
            (fn.variables.has(node.name) ||
              redefined_within_scope(node.definition(), fn))
          ) {
    ...
    function extract_args() {
      ...
      if (
        ...
        !fn.uses_arguments &&
        !fn.pinned() &&
        (iife = compressor2.parent()) instanceof AST_Call &&
        iife.expression === fn &&
        iife.args.every((arg2) => !(arg2 instanceof AST_Expansion))
      ) {
        ...
        for (var i2 = len; --i2 >= 0; ) {
          ...
          if (sym instanceof AST_Expansion) {
            ...
            if (!arg) {
              ...
              (arg instanceof AST_Lambda && arg.pinned()) ||
    ...
    function extract_candidates(expr) {
      ...
      if (expr instanceof AST_Assign) {
        if (
          !expr.left.has_side_effects(compressor2) &&
    ...
    function find_stop(node, level, write_only) {
      ...
      if (parent instanceof AST_Binary) {
        if (
          write_only &&
          (!lazy_op.has(parent.operator) || parent.left === node)
        ) {
          return find_stop(parent, level + 1, write_only);
        }
        return node;
    ...
    function get_lhs(expr) {
      if (expr instanceof AST_Assign && expr.logical) {
        ...
        expr instanceof AST_VarDef &&
        expr.name instanceof AST_SymbolDeclaration
      ) {
        var def2 = expr.name.definition();
        if (!member(expr.name, def2.orig)) return;
        ...
        if (
          ...
          (referenced > 1 ? mangleable_var(expr) : !compressor2.exposed(def2))
        ) {
        ...
        return (
          !is_ref_of(lhs2, AST_SymbolConst) &&
          !is_ref_of(lhs2, AST_SymbolLet) &&
          lhs2
        );
      }
    }
    ...
    function get_lvalues(expr) {
      ...
      if (expr instanceof AST_Unary) return lvalues2;
      var tw = new TreeWalker(function (node) {
        var sym = node;
    ...
    function remove_candidate(expr) {
      if (expr.name instanceof AST_SymbolFunarg) {
        var iife = compressor2.parent(),
          argnames = compressor2.self().argnames;
      ...
      var found = false;
      return statements2[stat_index].transform(
        new TreeTransformer(
              ...
              if (node instanceof AST_VarDef) {
                node.value =
                  node.name instanceof AST_SymbolConst
                    ? make_node(AST_Undefined, node.value)
                    : null;
                return node;
              }
    ...
    function is_lhs_local(lhs2) {
      while (lhs2 instanceof AST_PropAccess) lhs2 = lhs2.expression;
      return (
        lhs2 instanceof AST_SymbolRef &&
        lhs2.definition().scope === scope &&
        !(
          in_loop &&
          (lvalues.has(lhs2.name) ||
    ...
    function replace_all_symbols() {
      ...
      if (lhs instanceof AST_SymbolRef) {
        ...
        if (
          def2.references.length - def2.replaced ==
    ...
    function may_modify(sym) {
      ...
      if (def2.orig.length == 1 && def2.orig[0] instanceof AST_SymbolDefun)
        return false;
      if (def2.scope.get_defun_scope() !== scope) return true;
      return !def2.references.every((ref) => {
    ...
    function shadows(newScope, lvalues2) {
      for (const { def: def2 } of lvalues2.values()) {
        let current = newScope;
        while (current && current !== def2.scope) {
          let nested_def = current.variables.get(def2.name);
          if (nested_def && nested_def !== def2) return true;
  ...
  function eliminate_spurious_blocks(statements2) {
    ...
    for (var i = 0; i < statements2.length; ) {
      ...
      if (
        stat instanceof AST_BlockStatement &&
        stat.body.every(can_be_evicted_from_block)
      ) {
        CHANGED = true;
  ...
  function handle_if_return(statements2, compressor2) {
    ...
    for (var i = statements2.length; --i >= 0; ) {
      ...
      if (stat instanceof AST_If && stat.body instanceof AST_Return) {
        ...
        if (
          ...
          statements2[i] = stat.transform(compressor2);
          if (next) statements2.splice(j, 1);
          continue;
        }
        var prev = statements2[prev_index(i)];
        if (
          compressor2.option("sequences") &&
          in_lambda &&
          !stat.alternative &&
          prev instanceof AST_If &&
          prev.body instanceof AST_Return &&
          next_index(j) == statements2.length &&
    ...
    function is_return_void(value2) {
      return (
        !value2 ||
        (value2 instanceof AST_UnaryPrefix && value2.operator == "void")
      );
    }
    function can_merge_flow(ab2) {
      ...
      var lct =
        ab2 instanceof AST_LoopControl
          ? compressor2.loopcontrol_target(ab2)
          : null;
      return (
        (ab2 instanceof AST_Return && in_lambda && is_return_void(ab2.value)) ||
        (ab2 instanceof AST_Continue && self2 === loop_body(lct)) ||
        (ab2 instanceof AST_Break &&
    ...
    function as_statement_array_with_return(node, ab2) {
      ...
      if (ab2.value) {
        body2.push(
          make_node(AST_SimpleStatement, ab2.value, {
      ...
      if (stat instanceof AST_LoopControl) {
        ...
        if (
          (stat instanceof AST_Break &&
            ...
            loop_body(lct) === self2) ||
          (stat instanceof AST_Continue && loop_body(lct) === self2)
        ) {
          if (stat.label) {
  ...
  function sequencesize(statements2, compressor2) {
    if (statements2.length < 2) return;
    var seq = [],
      n = 0;
    function push_seq() {
    ...
    for (var i = 0, len = statements2.length; i < len; i++) {
      ...
      if (stat instanceof AST_SimpleStatement) {
        if (seq.length >= compressor2.sequences_limit) push_seq();
        var body = stat.body;
        if (seq.length > 0) body = body.drop_side_effect_free(compressor2);
    ...
    for (var i = 0; i < statements2.length; i++) {
      ...
      if (prev) {
        if (stat instanceof AST_Exit) {
          stat.value = cons_seq(
            stat.value || make_node(AST_Undefined, stat).transform(compressor2)
          );
          ...
          if (
            !(stat.init instanceof AST_Const) &&
            !(stat.init instanceof AST_Let)
          ) {
...
var Compressor = class extends TreeWalker {
  constructor(
    options,
    { false_by_default = false, mangle_options: mangle_options2 = false }
  ) {
    super();
    ...
    this.mangle_options = mangle_options2;
  }
  option(key) {
  ...
  in_boolean_context() {
    ...
    for (var i = 0, p; (p = this.parent(i)); i++) {
      if (
        ...
        (p instanceof AST_Conditional && p.condition === self2) ||
        (p instanceof AST_DWLoop && p.condition === self2) ||
        (p instanceof AST_For && p.condition === self2) ||
        (p instanceof AST_If && p.condition === self2) ||
...
AST_Toplevel.DEFMETHOD("drop_console", function () {
  return this.transform(
    new TreeTransformer(function (self2) {
      if (self2.TYPE == "Call") {
...
AST_Scope.DEFMETHOD("process_expression", function (insert, compressor) {
  ...
  var tt = new TreeTransformer(function (node) {
    ...
    if (
      node instanceof AST_Class ||
      (node instanceof AST_Lambda && node !== self2)
    ) {
      return node;
    }
...
def_optimize(AST_Directive, function (self2, compressor) {
  if (
    ...
    (!directives.has(self2.value) ||
      compressor.has_directive(self2.value) !== self2)
  ) {
...
def_optimize(AST_LabeledStatement, function (self2, compressor) {
  if (
    self2.body instanceof AST_Break &&
    compressor.loopcontrol_target(self2.body) === self2.body
  ) {
    return make_node(AST_EmptyStatement, self2);
  }
    ...
    case 1:
      if (
        (!compressor.has_directive("use strict") &&
          ...
          can_be_extracted_from_if_block(self2.body[0])) ||
        can_be_evicted_from_block(self2.body[0])
      ) {
        return self2.body[0];
      }
      break;
...
function opt_AST_Lambda(self2, compressor) {
  ...
  if (
    ...
    self2.body.length == 1 &&
    self2.body[0] === compressor.has_directive("use strict")
  ) {
    self2.body.length = 0;
  }
  return self2;
...
AST_Scope.DEFMETHOD("drop_unused", function (compressor) {
  ...
  var drop_funcs =
    !(self2 instanceof AST_Toplevel) || compressor.toplevel.funcs;
  var drop_vars = !(self2 instanceof AST_Toplevel) || compressor.toplevel.vars;
  const assign_as_unused = r_keep_assign.test(compressor.option("unused"))
    ? return_false
    : function (node) {
        if (
          node instanceof AST_Assign &&
        ...
        if (in_export || !drop_vars) {
          walk(def.name, (node2) => {
            if (node2 instanceof AST_SymbolDeclaration) {
              ...
              if ((in_export || def2.global) && !in_use_ids.has(def2.id)) {
  ...
  var tt = new TreeTransformer(function before(node, descend, in_list) {
    ...
    if (drop_vars) {
      ...
      if (sym2 instanceof AST_SymbolRef) {
        ...
        if (node instanceof AST_Assign) {
          if (
            !in_use ||
            (fixed_ids.has(def.id) && fixed_ids.get(def.id) !== node)
          ) {
            return maintain_this_binding(
              parent,
              node,
              node.right.transform(tt)
            );
          }
        } else if (!in_use)
          return in_list
            ? MAP.skip
            : make_node(AST_Number, node, {
                value: 0,
              });
      }
    }
    ...
    if (
      ...
      let keep = (def2.global && !drop_funcs) || in_use_ids.has(def2.id);
      if (!keep) {
        def2.eliminated++;
        if (node instanceof AST_DefClass) {
          const side_effects2 = node.drop_side_effect_free(compressor);
          if (side_effects2) {
            return make_node(AST_SimpleStatement, node, {
              body: side_effects2,
            });
    ...
    if (
      ...
      node.definitions.forEach(function (def2) {
        ...
        var sym2 = is_destructure
          ? new SymbolDef(null, { name: "<destructure>" })
          : def2.name.definition();
        if (drop_block && sym2.global) return tail.push(def2);
        if (
          !(drop_vars || drop_block) ||
          (is_destructure &&
            (def2.name.names.length ||
              def2.name.is_array ||
              compressor.option("pure_getters") != true)) ||
          in_use_ids.has(sym2.id)
        ) {
          if (
            def2.value &&
            fixed_ids.has(sym2.id) &&
            fixed_ids.get(sym2.id) !== def2
          ) {
          ...
          if (def2.name instanceof AST_SymbolVar) {
            ...
            if (
              var_defs.length > 1 &&
              (!def2.value || sym2.orig.indexOf(def2.name) > sym2.eliminated)
            ) {
              if (def2.value) {
  ...
  function scan_ref_scoped(node, descend) {
    ...
    if (
      ...
      self2.variables.get(sym.name) === (node_def = sym.definition())
    ) {
      if (node instanceof AST_Assign) {
        node.right.walk(tw);
...
AST_Scope.DEFMETHOD("hoist_declarations", function (compressor) {
  var self2 = this;
  if (compressor.has_directive("use asm")) return self2;
  if (!Array.isArray(self2.body)) return self2;
  ...
  if (hoist_funs || hoist_vars) {
    ...
    var vars = new Map(),
      ...
      var_decl = 0;
    walk(self2, (node) => {
      if (node instanceof AST_Scope && node !== self2) return true;
      if (node instanceof AST_Var) {
        ++var_decl;
        return true;
      }
      ...
      if (node !== self2) {
        ...
        if (
          ...
          !node.definitions.some(
            (def3) => def3.name instanceof AST_Destructuring
          )
        ) {
        ...
        for (var i = 0; i < self2.body.length; ) {
          if (self2.body[i] instanceof AST_SimpleStatement) {
            ...
            if (
              ...
              remove(defs, def);
              defs.push(def);
              self2.body[i].body = make_sequence(
                expr,
...
AST_Scope.DEFMETHOD("hoist_properties", function (compressor) {
  ...
  if (!compressor.option("hoist_props") || compressor.has_directive("use asm"))
    return self2;
  var top_retain =
    (self2 instanceof AST_Toplevel && compressor.top_retain) || return_false;
  var defs_by_id = new Map();
  var hoister = new TreeTransformer(function (node, descend) {
    if (
      node instanceof AST_Definitions &&
      hoister.parent() instanceof AST_Export
    )
      return node;
    if (node instanceof AST_VarDef) {
      const sym = node.name;
...
def_optimize(AST_While, function (self2, compressor) {
  return compressor.option("loops")
    ? make_node(AST_For, self2, self2).optimize(compressor)
    : self2;
});
...
function if_break_in_loop(self2, compressor) {
  var first =
    self2.body instanceof AST_BlockStatement ? self2.body.body[0] : self2.body;
  if (compressor.option("dead_code") && is_break(first)) {
    ...
    if (self2.init instanceof AST_Statement) {
      ...
      body.push(
        make_node(AST_SimpleStatement, self2.init, {
          body: self2.init,
        })
      );
    }
  ...
  if (self2.condition) {
    ...
    if (!(cond instanceof AST_Node)) {
      if (cond) self2.condition = null;
        ...
        self2.condition = best_of_expression(
          self2.condition.transform(compressor),
          orig
        );
      }
    }
    if (compressor.option("dead_code")) {
      ...
      if (!cond) {
        ...
        return make_node(AST_BlockStatement, self2, { body }).optimize(
          compressor
        );
      }
    }
...
def_optimize(AST_If, function (self2, compressor) {
  ...
  if (
    self2.body instanceof AST_SimpleStatement &&
    self2.alternative instanceof AST_SimpleStatement
  ) {
  ...
  if (
    is_empty(self2.alternative) &&
    self2.body instanceof AST_SimpleStatement
  ) {
    if (
      self_condition_length === negated_length &&
      !negated_is_best &&
      self2.condition instanceof AST_Binary &&
      self2.condition.operator == "||"
    ) {
  ...
  if (
    self2.body instanceof AST_EmptyStatement &&
    self2.alternative instanceof AST_SimpleStatement
  ) {
    return make_node(AST_SimpleStatement, self2, {
      body: make_node(AST_Binary, self2, {
  ...
  if (
    self2.body instanceof AST_Exit &&
    self2.alternative instanceof AST_Exit &&
    self2.body.TYPE == self2.alternative.TYPE
  ) {
    return make_node(self2.body.CTOR, self2, {
      value: make_node(AST_Conditional, self2, {
        ...
        alternative:
          self2.alternative.value ||
          make_node(AST_Undefined, self2.alternative),
      }).transform(compressor),
    }).optimize(compressor);
  }
  if (
    self2.body instanceof AST_If &&
    !self2.body.alternative &&
    !self2.alternative
  ) {
  ...
  if (aborts(self2.alternative)) {
    ...
    self2.condition = negated_is_best
      ? negated
      : self2.condition.negate(compressor);
    self2.alternative = null;
    return make_node(AST_BlockStatement, self2, {
      body: [self2, body],
    }).optimize(compressor);
...
def_optimize(AST_Switch, function (self2, compressor) {
  ...
  if (!(value instanceof AST_Node)) {
    ...
    self2.expression = best_of_expression(
      self2.expression.transform(compressor),
      orig
    );
  }
  ...
  if (
    body.every(
      (branch2, i2) =>
        (branch2 === default_or_exact ||
          branch2.expression instanceof AST_Constant) &&
        (branch2.body.length === 0 || aborts(branch2) || body.length - 1 === i2)
    )
  ) {
    for (let i2 = 0; i2 < body.length; i2++) {
      ...
      for (let j = i2 + 1; j < body.length; j++) {
        ...
        if (
          equivalentBranch ||
          (last_branch && branches_equivalent(next, branch2, true))
        ) {
  ...
  for (let i2 = 0; i2 < body.length; i2++) {
    ...
    for (let j = i2 + 1; j < body.length; i2++, j++) {
      ...
      if (next.body.length === 0) continue;
      if (
        branches_equivalent(next, branch2, false) ||
        (j === body.length - 1 && branches_equivalent(next, branch2, true))
      ) {
        branch2.body = [];
        branch2 = next;
        continue;
  ...
  DEFAULT: if (default_or_exact) {
    ...
    let sideEffect = body.find((branch2) => {
      return (
        branch2 !== default_or_exact &&
        branch2.expression.has_side_effects(compressor)
      );
    });
    if (!sideEffect) {
      return make_node(AST_BlockStatement, self2, {
        body: decl.concat(
          ...
          default_or_exact.expression
            ? statement(default_or_exact.expression)
            : [],
          caseBody || []
        ),
      }).optimize(compressor);
  ...
  function is_break(node, stack) {
    return (
      node instanceof AST_Break && stack.loopcontrol_target(node) === self2
    );
  }
  function is_inert_body(branch2) {
    return (
      !aborts(branch2) &&
      !make_node(AST_BlockStatement, branch2, {
        body: branch2.body,
...
def_optimize(AST_Try, function (self2, compressor) {
  ...
  if (self2.bcatch && self2.bfinally && self2.bfinally.body.every(is_empty))
    self2.bfinally = null;
  if (compressor.option("dead_code") && self2.body.every(is_empty)) {
    var body = [];
    if (self2.bcatch) {
...
def_optimize(AST_VarDef, function (self2, compressor) {
  if (
    self2.name instanceof AST_SymbolLet &&
    self2.value != null &&
    is_undefined(self2.value, compressor)
  ) {
    self2.value = null;
  }
  return self2;
...
def_optimize(AST_Call, function (self2, compressor) {
  ...
  if (
    ...
    !has_annotation(self2, _NOINLINE)
  ) {
      ...
      switch (exp.name) {
        case "Array":
          if (self2.args.length != 1) {
            ...
            self2.args[0] instanceof AST_Number &&
            self2.args[0].value <= 11
          ) {
            const elements2 = [];
        ...
        case "Symbol":
          if (
            self2.args.length == 1 &&
            self2.args[0] instanceof AST_String &&
      ...
      try {
        var code =
          ...
          self2.args
            ...
            .join(",") +
          "){" +
          self2.args[self2.args.length - 1].value +
          "})";
        var ast = parse(code);
  ...
  var can_inline =
    ...
    !self2.is_callee_pure(compressor);
  if (can_inline && stat instanceof AST_Return) {
    ...
    if (
      ...
      const replacement = (self2.args[0] || make_node(AST_Undefined)).optimize(
        compressor
      );
      let parent;
      if (
  ...
  if (can_inline) {
    ...
    if (
      ...
      (exp === fn ||
        has_annotation(self2, _INLINE) ||
        (compressor.option("unused") &&
          (def = exp.definition()).references.length == 1 &&
          !is_recursive_ref(compressor, def) &&
          fn.is_constant_expression(exp.scope))) &&
      !has_annotation(self2, _PURE | _NOINLINE) &&
      !fn.contains_this() &&
      can_inject_symbols() &&
      ...
      return make_sequence(self2, flatten_fn(returned_value)).optimize(
        compressor
      );
    }
  }
  ...
  function can_flatten_body(stat2) {
    var body = fn.body;
    var len2 = body.length;
    if (compressor.option("inline") < 3) {
      return len2 == 1 && return_value(stat2);
    }
    stat2 = null;
  ...
  function can_inject_args(block_scoped, safe_to_inject) {
    for (var i2 = 0, len2 = fn.argnames.length; i2 < len2; i2++) {
      var arg2 = fn.argnames[i2];
      if (arg2 instanceof AST_DefaultAssign) {
        if (has_flag(arg2.left, UNUSED)) continue;
        return false;
      }
      if (arg2 instanceof AST_Destructuring) return false;
      if (arg2 instanceof AST_Expansion) {
        if (has_flag(arg2.expression, UNUSED)) continue;
        return false;
      }
      if (has_flag(arg2, UNUSED)) continue;
      if (
        !safe_to_inject ||
        block_scoped.has(arg2.name) ||
        identifier_atom.has(arg2.name) ||
        scope.conflicting_def(arg2.name)
      ) {
        return false;
      }
      if (in_loop) in_loop.push(arg2.definition());
    }
    return true;
  }
  function can_inject_vars(block_scoped, safe_to_inject) {
    var len2 = fn.body.length;
    for (var i2 = 0; i2 < len2; i2++) {
  ...
  function flatten_args(decls, expressions) {
    var len2 = fn.argnames.length;
    for (var i2 = self2.args.length; --i2 >= len2; ) {
      expressions.push(self2.args[i2]);
    }
    for (i2 = len2; --i2 >= 0; ) {
      var name = fn.argnames[i2];
      var value2 = self2.args[i2];
      if (
        has_flag(name, UNUSED) ||
        !name.name ||
        scope.conflicting_def(name.name)
      ) {
        if (value2) expressions.push(value2);
      } else {
        var symbol = make_node(AST_SymbolVar, name, name);
        name.definition().orig.push(symbol);
        if (!value2 && in_loop) value2 = make_node(AST_Undefined, self2);
  ...
  function flatten_vars(decls, expressions) {
    ...
    for (var i2 = 0, lines = fn.body.length; i2 < lines; i2++) {
      var stat2 = fn.body[i2];
      if (!(stat2 instanceof AST_Var)) continue;
  ...
  function flatten_fn(returned_value) {
    ...
    if (decls.length) {
      const i2 = scope.body.indexOf(compressor.parent(level - 1)) + 1;
      scope.body.splice(
        i2,
        0,
...
def_optimize(AST_New, function (self2, compressor) {
  if (
    ...
    is_undeclared_ref(self2.expression) &&
    ["Object", "RegExp", "Function", "Error", "Array"].includes(
      self2.expression.name
    )
  )
...
def_optimize(AST_UnaryPrefix, function (self2, compressor) {
  ...
  if (
    ...
    return make_sequence(self2, [e, make_node(AST_True, self2)]).optimize(
      compressor
    );
  }
      ...
      case "typeof":
        return (
          e instanceof AST_SymbolRef
            ...
            : make_sequence(self2, [e, make_node(AST_True, self2)])
        ).optimize(compressor);
    }
  }
  ...
  if (
    self2.operator != "-" ||
    !(
      e instanceof AST_Number ||
      e instanceof AST_Infinity ||
      e instanceof AST_BigInt
    )
  ) {
    var ev = self2.evaluate(compressor);
    if (ev !== self2) {
...
def_optimize(AST_Binary, function (self2, compressor) {
  function reversible() {
    return (
      self2.left.is_constant() ||
      self2.right.is_constant() ||
      (!self2.left.has_side_effects(compressor) &&
        !self2.right.has_side_effects(compressor))
    );
  }
  function reverse(op) {
    if (reversible()) {
  ...
  if (commutativeOperators.has(self2.operator)) {
    if (self2.right.is_constant() && !self2.left.is_constant()) {
      if (
        !(
          self2.left instanceof AST_Binary &&
          PRECEDENCE[self2.left.operator] >= PRECEDENCE[self2.operator]
        )
      ) {
        reverse();
      }
  ...
  if (compressor.option("comparisons"))
    switch (self2.operator) {
      ...
      case "!==":
        ...
        if (
          (self2.left.is_string(compressor) &&
            self2.right.is_string(compressor)) ||
          (self2.left.is_number(compressor) &&
            self2.right.is_number(compressor)) ||
          (self2.left.is_boolean() && self2.right.is_boolean()) ||
          self2.left.equivalent_to(self2.right)
        ) {
      ...
      case "!=":
        if (!is_strict_comparison && is_undefined(self2.left, compressor)) {
          ...
          compressor.option("typeofs") &&
          self2.left instanceof AST_String &&
          self2.left.value == "undefined" &&
          self2.right instanceof AST_UnaryPrefix &&
          self2.right.operator == "typeof"
        ) {
          ...
          if (
            ...
            self2.right = expr;
            self2.left = make_node(AST_Undefined, self2.left).optimize(
              compressor
            );
            if (self2.operator.length == 2) self2.operator += "=";
          }
        } else if (
          self2.left instanceof AST_SymbolRef &&
          self2.right instanceof AST_SymbolRef &&
          self2.left.definition() === self2.right.definition() &&
          is_object(self2.left.fixed_value())
        ) {
          return make_node(
            self2.operator[0] == "=" ? AST_True : AST_False,
            self2
          );
        }
        break;
      ...
      case "||":
        ...
        if (
          ...
          lhs.operator == (self2.operator == "&&" ? "!==" : "===") &&
          self2.right instanceof AST_Binary &&
          lhs.operator == self2.right.operator &&
          ((is_undefined(lhs.left, compressor) &&
            self2.right.left instanceof AST_Null) ||
            (lhs.left instanceof AST_Null &&
              is_undefined(self2.right.left, compressor))) &&
          !lhs.right.has_side_effects(compressor) &&
          lhs.right.equivalent_to(self2.right.right)
        ) {
  ...
  if (self2.operator == "+") {
    if (
      self2.right instanceof AST_String &&
      self2.right.getValue() == "" &&
      self2.left.is_string(compressor)
    ) {
      return self2.left;
    }
    ...
    if (
      self2.left instanceof AST_Binary &&
      self2.left.operator == "+" &&
      self2.left.left instanceof AST_String &&
      self2.left.left.getValue() == "" &&
      self2.right.is_string(compressor)
    ) {
  ...
  if (compressor.option("evaluate")) {
    switch (self2.operator) {
      case "&&":
        var ll = has_flag(self2.left, TRUTHY)
          ? true
          : has_flag(self2.left, FALSY)
          ? false
          : self2.left.evaluate(compressor);
        if (!ll) {
          return maintain_this_binding(
            compressor.parent(),
            compressor.self(),
          ...
          return make_sequence(self2, [self2.left, self2.right]).optimize(
            compressor
          );
        }
        var rr = self2.right.evaluate(compressor);
    ...
    switch (self2.operator) {
      case "+":
        if (
          self2.right instanceof AST_Constant &&
          self2.left instanceof AST_Binary &&
          self2.left.operator == "+" &&
          self2.left.is_string(compressor)
        ) {
        ...
        if (
          self2.left instanceof AST_UnaryPrefix &&
          self2.left.operator == "-" &&
          reversible() &&
          self2.right.is_number(compressor)
        ) {
        ...
        if (
          self2.left instanceof AST_TemplateString &&
          self2.right instanceof AST_TemplateString
        ) {
          var l = self2.left;
      ...
      case "^":
        if (
          ...
          !(
            self2.left instanceof AST_Binary &&
            self2.left.operator != self2.operator &&
            PRECEDENCE[self2.left.operator] >= PRECEDENCE[self2.operator]
          )
        ) {
          ...
          if (
            self2.right instanceof AST_Constant &&
            !(self2.left instanceof AST_Constant)
          ) {
        ...
        if (associative && self2.is_number(compressor)) {
          if (
            self2.right instanceof AST_Binary &&
            self2.right.operator == self2.operator
          ) {
            self2 = make_node(AST_Binary, self2, {
              operator: self2.operator,
              left: make_node(AST_Binary, self2.left, {
          ...
          if (
            self2.left instanceof AST_Binary &&
            self2.left.operator == self2.operator &&
            self2.left.right instanceof AST_Constant &&
            self2.right instanceof AST_Binary &&
            self2.right.operator == self2.operator &&
            self2.right.left instanceof AST_Constant
          ) {
            self2 = make_node(AST_Binary, self2, {
              operator: self2.operator,
              left: make_node(AST_Binary, self2.left, {
  ...
  if (
    self2.right instanceof AST_Binary &&
    self2.right.operator == self2.operator &&
    (lazy_op.has(self2.operator) ||
      (self2.operator == "+" &&
        (self2.right.left.is_string(compressor) ||
          (self2.left.is_string(compressor) &&
            self2.right.right.is_string(compressor)))))
  ) {
...
function is_reachable(self2, defs) {
  const find_ref = (node) => {
    if (node instanceof AST_SymbolRef && member(node.definition(), defs)) {
      return walk_abort;
    }
  };
  return walk_parent(self2, (node, info) => {
...
def_optimize(AST_Assign, function (self2, compressor) {
  ...
  if (
    ...
    self2.left instanceof AST_SymbolRef &&
    (def = self2.left.definition()).scope === compressor.find_parent(AST_Lambda)
  ) {
    var level = 0,
      node,
      parent = self2;
  ...
  if (
    ...
    if (
      self2.right.left instanceof AST_SymbolRef &&
      self2.right.left.name == self2.left.name &&
      ASSIGN_OPS.has(self2.right.operator)
    ) {
      self2.operator = self2.right.operator + "=";
      self2.right = self2.right.right;
    } else if (
      self2.right.right instanceof AST_SymbolRef &&
      self2.right.right.name == self2.left.name &&
      ASSIGN_OPS_COMMUTATIVE.has(self2.right.operator) &&
      !self2.right.left.has_side_effects(compressor)
    ) {
      self2.operator = self2.right.operator + "=";
  ...
  function in_try(level2, node2) {
    var right = self2.right;
    self2.right = make_node(AST_Null, right);
    var may_throw = node2.may_throw(compressor);
    self2.right = right;
    var scope = self2.left.definition().scope;
    var parent2;
    while ((parent2 = compressor.parent(level2++)) !== scope) {
      if (parent2 instanceof AST_Try) {
        if (parent2.bfinally) return true;
        if (may_throw && parent2.bcatch) return true;
      }
    }
  }
});
...
function is_nullish_check(check, check_subject, compressor) {
  ...
  if (
    ...
    (nullish_side === check.left ? check.right : check.left).equivalent_to(
      check_subject
    )
  ) {
    return true;
...
def_optimize(AST_Conditional, function (self2, compressor) {
  ...
  if (
    ...
    (!self2.condition.has_side_effects(compressor) ||
      (consequent.operator == "=" &&
  ...
  if (
    alternative instanceof AST_Conditional &&
  ...
  if (
    alternative instanceof AST_Binary &&
  ...
  if (consequent.equivalent_to(alternative)) {
    return make_sequence(self2, [self2.condition, consequent]).optimize(
      compressor
    );
  }
  if (
  ...
  function is_true(node2) {
    return (
      node2 instanceof AST_True ||
      (in_bool && node2 instanceof AST_Constant && node2.getValue()) ||
      (node2 instanceof AST_UnaryPrefix &&
        node2.operator == "!" &&
        node2.expression instanceof AST_Constant &&
        !node2.expression.getValue())
    );
  }
  function is_false(node2) {
    return (
      node2 instanceof AST_False ||
      (in_bool && node2 instanceof AST_Constant && !node2.getValue()) ||
      (node2 instanceof AST_UnaryPrefix &&
        node2.operator == "!" &&
        node2.expression instanceof AST_Constant &&
...
AST_PropAccess.DEFMETHOD("flatten_object", function (key, compressor) {
  ...
  if (expr instanceof AST_Object) {
    ...
    for (var i = props.length; --i >= 0; ) {
      var prop = props[i];
      if (
        "" + (prop instanceof AST_ConciseMethod ? prop.key.name : prop.key) ==
        key
      ) {
...
def_optimize(AST_Sub, function (self2, compressor) {
  ...
  if (compressor.option("properties")) {
    ...
    if (key !== prop) {
      ...
      var property = "" + key;
      if (
        is_basic_identifier_string(property) &&
  ...
  if (is_lhs(self2, compressor.parent())) return self2;
  if (key !== prop) {
...
def_optimize(AST_Dot, function (self2, compressor) {
  const parent = compressor.parent();
  if (is_lhs(self2, parent)) return self2;
  if (
    compressor.option("unsafe_proto") &&
    self2.expression instanceof AST_Dot &&
    self2.expression.property == "prototype"
  ) {
...
function literals_in_boolean_context(self2, compressor) {
  if (compressor.in_boolean_context()) {
    return best_of(
      compressor,
      self2,
      make_sequence(self2, [self2, make_node(AST_True, self2)]).optimize(
        compressor
      )
    );
  }
  ...
  for (var i = 0; i < props.length; i++) {
    ...
    if (prop instanceof AST_Expansion) {
      ...
      if (
        ...
        expr.properties.every((prop2) => prop2 instanceof AST_ObjectKeyVal)
      ) {
...
def_optimize(AST_Yield, function (self2, compressor) {
  if (
    self2.expression &&
    !self2.is_star &&
    is_undefined(self2.expression, compressor)
  ) {
...
def_optimize(AST_TemplateString, function (self2, compressor) {
  ...
  for (var i = 0; i < self2.segments.length; i++) {
    ...
    if (segment instanceof AST_Node) {
      ...
      if (
        result !== segment &&
        (result + "").length <= segment.size() + "${}".length
      ) {
        segments[segments.length - 1].value =
          segments[segments.length - 1].value +
          result +
          self2.segments[++i].value;
        continue;
      }
...
function lift_key(self2, compressor) {
  ...
  if (self2.key instanceof AST_String || self2.key instanceof AST_Number) {
    if (self2.key.value === "__proto__") return self2;
    if (
      self2.key.value == "constructor" &&
      compressor.parent() instanceof AST_Class
    )
      return self2;
...
def_optimize(AST_ConciseMethod, function (self2, compressor) {
  ...
  if (
    ...
    !self2.is_generator &&
    !self2.value.uses_arguments &&
    !self2.value.pinned() &&
    self2.value.body.length == 1 &&
    self2.value.body[0] instanceof AST_Return &&
    self2.value.body[0].value &&
    !self2.value.contains_this()
  ) {
...
def_optimize(AST_ObjectKeyVal, function (self2, compressor) {
  ...
  if (
    unsafe_methods &&
    compressor.option("ecma") >= 2015 &&
    (!(unsafe_methods instanceof RegExp) || unsafe_methods.test(self2.key + ""))
  ) {
    var key = self2.key;
    var value = self2.value;
    var is_arrow_with_block =
      value instanceof AST_Arrow &&
    ...
    if ((is_arrow_with_block || value instanceof AST_Function) && !value.name) {
      return make_node(AST_ConciseMethod, self2, {
        ...
        key:
          key instanceof AST_Node
            ? key
            : make_node(AST_SymbolMethod, self2, {
                name: key,
              }),
...
def_optimize(AST_Destructuring, function (self2, compressor) {
  if (
    ...
    compressor.option("unused") &&
    !self2.is_array &&
    Array.isArray(self2.names) &&
    !is_destructuring_export_decl(compressor) &&
    !(self2.names[self2.names.length - 1] instanceof AST_Expansion)
  ) {
    var keep = [];
    for (var i = 0; i < self2.names.length; i++) {
      ...
      if (
        !(
          elem instanceof AST_ObjectKeyVal &&
...
async function SourceMap(options) {
  ...
  var orig_map;
  var generator = new import_source_map.default.SourceMapGenerator({
    file: options.file,
    sourceRoot: options.root,
  });
  if (options.orig) {
    orig_map = await new import_source_map.default.SourceMapConsumer(
      options.orig
    );
...
function mangle_properties(ast, options) {
  ...
  function mangleStrings(node) {
    return node.transform(
      new TreeTransformer(function (node2) {
        if (node2 instanceof AST_Sequence) {
  ...
  if (files instanceof AST_Toplevel) {
    ...
    if (options.parse.spidermonkey) {
      options.parse.toplevel = AST_Node.from_mozilla_ast(
        Object.keys(files).reduce(function (toplevel2, name2) {
